...
- Location: e2e\homepage.spec.ts:40:3
...
Locator: locator('[class*="property"], [class*="card"], [class*="property"]').first()
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for locator('[class*="property"], [class*="card"], [class*="property"]').first()
