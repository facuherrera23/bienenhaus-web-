...
- Name: homepage.spec.ts >> Contact section >> contact section is present on homepage
- Location: e2e\homepage.spec.ts:51:3
...
Locator: locator('a[href*="wa.me"], a[href*="whatsapp"], button:has-text("WhatsApp"), .whatsapp-float').first()
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('a[href*="wa.me"], a[href*="whatsapp"], button:has-text("WhatsApp"), .whatsapp-float').first()
