import { Group, BoxGeometry, Mesh, PlaneGeometry, EdgesGeometry, LineSegments, LineBasicMaterial, IcosahedronGeometry } from 'three';
import { concreteMaterial, glassMaterial, waterMaterial, gardenLightMaterial, signalGlowMaterial } from './glowMaterial';
 ...
 * Materiales: emissive Signal #2ee6c5 solo en pileta y tiras de jardín
 */
...
// Re-export three types for consumers
